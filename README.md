...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/diff-cover-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/diff-cover-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install diff-cover
```
...
It is possible to list all of the versions of `diff-cover` available on your platform:
...
```
pixi search diff-cover --channel conda-forge
```
